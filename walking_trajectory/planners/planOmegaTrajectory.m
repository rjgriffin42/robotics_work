function [omegaTrajectory, omegaDotTrajectory] = planOmegaTrajectory(cmpTrajectory, comHeightTrajectory, comDotHeightTrajectory, comDotDotHeighTrajectory, timeVector)
